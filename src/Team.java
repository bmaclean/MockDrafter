...
public enum Team {
    ...
    IND("Indianapolis Colts", new ArrayList<>(Arrays.asList(Position.EDGE, Position.RB, Position.ILB, Position.CB)), 14),
    ...
    JAX("Jacksonville Jaguars", new ArrayList<>(Arrays.asList(Position.OT, Position.DT, Position.S)), 4),

    //AFCN
    CIN("Cincinatti Bengals", new ArrayList<>(Arrays.asList(Position.C, Position.ILB, Position.OLB, Position.EDGE)), 9),
    PIT("Pittsburgh Steelers", new ArrayList<>(Arrays.asList(Position.ILB, Position.OLB, Position.TE)), 30),
    BAL("Baltimore Ravens", new ArrayList<>(Arrays.asList(Position.EDGE, Position.S, Position.WR)), 16),
    CLE("Cleveland Browns", new ArrayList<>(Arrays.asList(Position.QB, Position.EDGE, Position.RB)), 1),

    //AFCE
    NE("New England Patriots", new ArrayList<>(Arrays.asList(Position.OT, Position.ILB, Position.OLB, Position.RB)), 32),
    MIA("Miami Dolphins", new ArrayList<>(Arrays.asList(Position.OG, Position.EDGE, Position.TE)), 22),
    BUF("Buffalo Bills", new ArrayList<>(Arrays.asList(Position.OT, Position.WR, Position.CB, Position.S)), 10),
    NYJ("New York Jets", new ArrayList<>(Arrays.asList(Position.QB, Position.OT, Position.CB, Position.EDGE)), 6),
    ...
    NO("New Orleans Saints", new ArrayList<>(Arrays.asList(Position.S, Position.CB, Position.ILB)), 11),
    ...
    MIN("Minnesota Vikings", new ArrayList<>(Arrays.asList(Position.OT, Position.RB, Position.DT)), 15),
    GB("Green Bay Packers", new ArrayList<>(Arrays.asList(Position.CB, Position.ILB, Position.OLB, Position.EDGE)), 29),
    CHI("Chicago Bears", new ArrayList<>(Arrays.asList(Position.QB, Position.CB, Position.S)), 3),
    ...
    LAR("Los Angeles Rams", new ArrayList<>(Arrays.asList(Position.CB, Position.WR, Position.OG)), 5),
    SF("San Francisco 49ers", new ArrayList<>(Arrays.asList(Position.QB, Position.OLB, Position.WR)), 2);
